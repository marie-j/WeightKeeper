package fr.maxime_agusti.weightkeeper.fragment;
...
import fr.maxime_agusti.weightkeeper.activity.RecordDetailActivity;
import fr.maxime_agusti.weightkeeper.activity.RecordListActivity;
...
public class RecordDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.record_detail)).setText(mItem.details);
        }
